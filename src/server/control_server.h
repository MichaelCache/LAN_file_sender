...
class ControlServer : public QTcpServer {
 ...
 public Q_SLOTS:
  ...
  // void onAcceptSend(const QVector<FileInfo>& filenames, const QHostAddress& src);

 Q_SIGNALS:
  void acceptSendFile(const QVector<FileInfo>& filenames, const QHostAddress& dst);
  void denySendFile(const QVector<FileInfo>& filenames, const QHostAddress& dst);
  void recieveFileInfo(const QVector<FileInfo>& filenames, const QHostAddress& dst);
  void cancelFileInfo(const QVector<FileInfo>& filenames, const QHostAddress& dst);
